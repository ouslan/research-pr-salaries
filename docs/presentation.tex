...
\begin{frame}{Literature Summary}
	\begin{itemize}
		\item \textbf{Negative Relationship:} Freeman (1992) found 8\%--10\% employment reduction; Neumark (2000) linked high minimum wages to high unemployment.
		\item \textbf{Mixed Results:} Card \& Krueger (1994) found no significant effect; Caraballo-Cueto (2016) observed slight positive short-run effects.
		\item \textbf{Puerto Rico Specific:} Federal Reserve (2012) suggested subminimum wages for youth; Hernández (2017) found total employment reductions post-increase.
	\end{itemize}
\end{frame}
