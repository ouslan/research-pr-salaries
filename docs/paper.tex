...
\begin{table}[H]
	...
	\begin{tabular}{lccc}
		...
		\bottomrule
	\end{tabular}
	\caption{Regression Results: Parameter Estimates and Confidence Intervals (Queen)}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{lc}
		...
		\bottomrule
	\end{tabular}
	\caption{R-Hat for Individual Variables (queen)}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{lccc}
		...
		\bottomrule
	\end{tabular}
	\caption{Regression Results: Parameter Estimates and Confidence Intervals (KNN6)}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{lc}
		...
		\bottomrule
	\end{tabular}
	\caption{R-Squared for Individual Variables (KNN6)}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{lccc}
		...
		\bottomrule
	\end{tabular}
	\caption{Regression Results: Parameter Estimates and Confidence Intervals (Distance)}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{lc}
		...
		\bottomrule
	\end{tabular}
	\caption{R-Squared for Individual Variables (Distance)}
\end{table}
...
\begin{figure}[H]
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\caption{Summary of Regression Results (Queen)}
		\label{fig:queen}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.48\textwidth}
		...
		\caption{Summary of Regression Results (knn6)}
		\label{fig:knn6}
	\end{minipage}
\end{figure}
