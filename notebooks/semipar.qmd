...
var = ["year", "p_snap", "car_truck_or_van_nn_drove_alone", "p_with_social_security", "population_16_years_and_over", "own_children_under_6_years", "own_children_6_to_17_years", "with_supplemental_security_incom", "latitude", "longitude"]
len(var)
```
...
gam = LinearGAM(s(0, n_splines=200) + s(1, n_splines=200) + s(2, n_splines=200) + s(3, n_splines=200) + s(4, n_splines=200) + s(5, n_splines=200) + s(6, n_splines=200) + s(7, n_splines=200) + te(8, 9)).fit(df[var].values, df[["total_employment"]].values)
gam.summary()
```
